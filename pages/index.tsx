    ...
    <Layout title={'Home'}>
      ...
      <section className='w-content-fit flex flex-col items-center justify-center m-5'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-center rounded-xl shadow-xl p-4'>
          ...
          <img className='hover:scale-125 duration-700 m-2' src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Angular_full_color_logo.svg/2048px-Angular_full_color_logo.svg.png' alt='angular' width='75px' height='75px' />
          <img className='hover:scale-125 duration-700 m-2' src='https://ngrx.io/assets/images/badge.svg' alt='ngrx' width='75px' height='75px' />
          <img
            className='hover:scale-125 duration-700 m-2'
            ...
            height='75px'
          />
          <img className='hover:scale-125 duration-700 m-2' src='https://25y35xxcueanov2s108puszp-wpengine.netdna-ssl.com/wp-content/uploads/2022/03/ext-553.png' alt='mongo db' width='75px' height='75px' />
          <img className='hover:scale-125 duration-700 m-2' src='https://thumbs.dreamstime.com/b/sql-database-icon-logo-design-ui-ux-app-orange-inscription-shadow-96841969.jpg' alt='sql' width='75px' height='75px' />
      ...
      <section className='w-full flex flex-col items-center justify-center m-5 '>
        ...
        <div className='flex flex-col md:flex-row items-center justify-center rounded-xl shadow-xl p-4'>
          ...
          <img className='hover:scale-125 duration-700 m-2' src='https://raw.githubusercontent.com/styled-components/brand/master/styled-components.png' alt='node js' width='75px' height='75px' />
        </div>
      </section>
    </Layout>
  )
