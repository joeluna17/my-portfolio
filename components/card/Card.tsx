...
const Card = ({ title, text, image }: CardProps) => {
  return (
    <div className='w-8/12 flex flex-col md:flex-row columns-2 rounded-md min-h-[300px] shadow-lg '>
      <div className={`flex flex-col justify-center ${image ? 'w-full md:w-6/12' : 'w-full'}  p-8`}>
