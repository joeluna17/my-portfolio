...
const Modal = () => {
  ...
  return (
    <div className={`${showModal ? 'flex' : 'hidden'} h-screen w-screen absolute top-0 left-0 bg-[rgba(0,0,0,0.5)] z-[9999]`}>
      <div id='defaultModal' aria-hidden='true' className='flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full'>
